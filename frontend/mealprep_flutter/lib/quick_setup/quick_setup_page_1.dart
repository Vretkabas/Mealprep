        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              // --- KEUZE OPTIES ---
              _buildOptionCard(0, "Gewicht verliezen", Icons.trending_down, Colors.redAccent),
              const SizedBox(height: 15),
              _buildOptionCard(1, "Gewicht behouden", Icons.balance, Colors.orangeAccent),
              const SizedBox(height: 15),
              _buildOptionCard(2, "Gewicht opbouwen", Icons.trending_up, Colors.green),
